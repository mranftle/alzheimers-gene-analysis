...
'''read in yml configs'''
with open('plotly_config.yml', 'r') as f:
    doc = yaml.load(f)
username = doc['username']
password = doc['password']
'''
    impute missing values in data set
'''
...
'''
    bottom-up clustering for classifications
'''
...
'''
    try clustering again using top-down clustering method
'''
...
'''
    Eigen vectors and values from pca
'''
...
'''
    KMeans using the top k eigen vectors, run from 0-20
'''
